...
assertSameValue('Palladium payload forwards trusted proxy IP', $allowTransport->lastPayload['server']['HTTP_X_FORWARDED_FOR'] ?? null, '203.0.113.10');
assertSameValue('Palladium payload forwards trusted proxy host', $allowTransport->lastPayload['server']['HTTP_X_FORWARDED_HOST'] ?? null, 'studiadesi.site');
assertSameValue('Palladium payload forwards request time', $allowTransport->lastPayload['server']['REQUEST_TIME_FLOAT'] ?? null, '1800000000.000000');
